...
echo "$(tput setaf 7) 4. $(tput setab 1)When this is done, run the commands within this virtualenv. If you are not in this virtual environment, it won't work.$(tput sgr 0)"
...
echo "$(tput setaf 7) 7. $(tput setab 8)You will probably have some issues with using the 'View' button, to fix it,$(tput sgr 0)"
...
echo "$(tput setaf 7) 8. $(tput setab 8)After, go back into the virtual environment with the command: $(tput setaf 3)sudo pipenv shell$(tput sgr 0)"
