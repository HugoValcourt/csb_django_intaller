...
echo "$(tput setaf 7) $(tput setab 1)THIS SCRIPT NEEDS TO BE RAN FROM THE USER'S HOME.$(tput sgr 0)"
...
echo "$(tput setaf 7) 2. $(tput setab 1)When this is done, run the commands within this virtualenv. If you are not in this virtual environment, it won't work.$(tput sgr 0)"
echo "$(tput setaf 7) $(tput setab 8)   The command to get in is: $(tput setaf 3)sudo pipenv shell$(tput sgr 0)"
echo "$(tput setaf 7) $(tput setab 8)   Then run:$(tput sgr 0)"
